...
ALLOWED_HOSTS = ['*']  # Render accepte tout avec *, tu peux restreindre plus tard
...
# Database → SQLite par défaut (parfait pour Render Free)
DATABASES = {
    'default': {
...
# Login URLs (optionnel, mais propre)
LOGIN_REDIRECT_URL = '/'
